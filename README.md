...
<br/><img width=50vw src="/assets/change_open_with_01.png" alt="change_open_with_01" />
- Search for 'Terminal', select it, and click 'Add'
<br/><img width=50vw src="/assets/change_open_with_02.png" alt="change_open_with_02" />
- Click 'Change All'
<br/><img width=50vw src="/assets/change_open_with_03.png" alt="change_open_with_03" />
- Exit 'Get Info'
